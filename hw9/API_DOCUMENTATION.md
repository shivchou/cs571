# CS571 S25 HW9 API Documentation
...
`GET` `https://cs571api.cs.wisc.edu/rest/s25/hw9/chatrooms`
...
`GET` `https://cs571api.cs.wisc.edu/rest/s25/hw9/messages?chatroom=CHATROOM_NAME`
...
### Registering a User
`POST` `https://cs571api.cs.wisc.edu/rest/s25/hw9/register`
...
`POST` `https://cs571api.cs.wisc.edu/rest/s25/hw9/login`
...
`POST` `https://cs571api.cs.wisc.edu/rest/s25/hw9/messages?chatroom=CHATROOM_NAME`
...
### Deleting a Message
`DELETE` `https://cs571api.cs.wisc.edu/rest/s25/hw9/messages?id=MESSAGE_ID`
...
### Who Am I?
`GET` `https://cs571api.cs.wisc.edu/rest/s25/hw9/whoami`
